...
echo '<key>' >> /etc/openvpn/easy-rsa/keys/client.ovpn
 ...
 1981  vim client.ovpn
 1982  ls /var/log/openvpn.log
 1983  tail -f /var/log/openvpn.log
 1984  sudo tail -f /var/log/openvpn.log
 1985  sudo tail -f /var/log/openvpn-status.log
 1986  sudo tail -f /var/log/openvpn.log

  186  source vars
  187  ./build-key client-papa
```
